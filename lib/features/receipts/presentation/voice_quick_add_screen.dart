...
class _VoiceQuickAddScreenState extends ConsumerState<VoiceQuickAddScreen>
  ...
  Future<void> _onSave([QuickAddDraft? parsedArg]) async {
    ...
    final currency = settings?.currency ?? Currency.USD;
    ...
    try {
      ...
      final receipt = ReceiptModel(
        ...
        items: [item],
        total: parsed.amount!,
        currency: currency, // Pass the correct currency here
      );
      ...
      if (!ok) {
        ...
        final formattedAmount =
            NumberFormat.currency(symbol: currency.name).format(parsed.amount);
